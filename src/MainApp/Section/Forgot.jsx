        ...
        <div className="row">
            <div className="col-sm-12 col-md-4 col-lg-7 login_left">
                ...
                <div className="row mt-5">
                    <div className="col-lg-12"><h1 className="text-black text-center text-bold">Reset your password</h1></div>
                </div>
                <div className="row">
                    <div className="col-lg-12"><p className="text-black text-center">If you signed up with a username and password, reset your password below.</p></div>
                </div>

                <div className="row">
                    <div className="col-lg-12"><p className="text-black text-center">If you signed up using your phone number, Google or Apple, get help accessing your account here.</p></div>
                </div>
                <div className="row">
                ...
                <div className="row">
                    <div className="col-lg-8 mx-auto mt-3">
                        <button type="button" className="btn w-100 btn-primary login-button">Forgot Password</button>
                    </div>
                </div>
