  ...
  return (
    <section className="login-section">
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-7 login-left">
            <div className="logo">
              <svg
                height="80%"
                viewBox="0 0 80 17"
            ...
            <div className="text-center mt-5">
              <h1 className="text-black text-bold">Welcome back!</h1>
              <p className="text-black">Log in to your Linktree.</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="mt-4">
              ...
              <div className="mb-3">
                <button
                  type="submit"
                  className="btn w-100 btn-primary login-button"
                >
                  Login
                </button>
              </div>
