...
import { signUp, loginRequest } from "../../features/auth/authSlice.js";
...
const Signup = () => {
  ...
  const handleSignUp = (event) => {
    event.preventDefault();
    dispatch(signUp({ username, first_name: firstName, last_name: lastName, email, password, password_confirmation: passwordConfirmation }))
      .then((response) => {
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-7 signup-left">
            ...
            <form onSubmit={step === 1 ? handleNextStep : handleSignUp} className="mt-4">
              {step === 1 && (
                <>
                  <div className="mb-3">
                    <input
