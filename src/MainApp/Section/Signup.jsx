        ...
        <div className="row">
            <div className="col-sm-12 col-md-4 col-lg-7 login_left">
                ...
                <div className="row mt-5">
                    <div className="col-lg-12"><h1 className="text-black text-center text-bold">Join Linktree!</h1></div>
                </div>
                <div className="row">
                    <div className="col-lg-12"><p className="text-black text-center">Sign up for free!</p></div>
                </div>

                <div className="row">
                    <div className="col-lg-8 mx-auto">
                        <input type="text" className="form-control" id="password" placeholder="Linktree"/>
                    </div>
                ...
                <div className="row">
                    <div className="col-lg-8 mx-auto mt-3">
                        <button type="button" className="btn w-100 btn-primary login-button">Create Account</button>
                    </div>
                </div>
                
                <div className="row">
                    <div className="col-lg-8 mx-auto mt-3">
                        <p className="text-center">By clicking Create account, you agree to Linktree's Terms and Conditions and confirm you have read our Privacy Notice.</p>
                    </div>
                </div>
