      ...
      <section>
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-7 login_left">
                ...
                <div class="row mt-5">
                    <div class="col-lg-12"><h1 class="text-black text-center text-bold">Join Linktree!</h1></div>
                </div>
                <div class="row">
                    <div class="col-lg-12"><p class="text-black text-center">Sign up for free!</p></div>
                </div>

                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <input type="text" class="form-control" id="password" placeholder="Linktree"/>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto mt-3">
                        <button type="button" class="btn w-100 btn-primary login-button">Create Account</button>
                    </div>
                </div>
                
                <div class="row">
                    <div class="col-lg-8 mx-auto mt-3">
                        <p class="text-center">By clicking Create account, you agree to Linktree's Terms and Conditions and confirm you have read our Privacy Notice.</p>
                    </div>
                </div>
